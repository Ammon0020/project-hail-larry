...
- [ ] **Rust backend port** — Phase 0 done. Phase 1: S-PATHUTIL/S-CONFIG/S-INTERFACES/S-EVENTS/S-MIGRATE/S-UPLOADS/S-SHELL/S-FSWATCH done. Shared **`src/fsutil`**. Phase 2: S-PERMISSIONS done. Next: service ports (pairing/workspace/…).
