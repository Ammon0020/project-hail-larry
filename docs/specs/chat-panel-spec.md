...
> **Status update 2026-06-27:** EXISTS = shipped in current codebase; NEW = backlog. See `plans/OpenItems.md` section 5 for UI feature requests.
> Companion to `mockup-chat-panel.html`. Covers every ACP event/feature in `docs/reference/acp/responsibilities.md`.
