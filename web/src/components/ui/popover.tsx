...
/**
 * Popover (shadcn/ui) — accessible floating panel built on Radix. Colors use
 * semantic tokens (popover/border) so it themes automatically.
 */
